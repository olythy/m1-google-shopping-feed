			...
			foreach ($attributes as $name => $value) {
				...
				foreach($value as $subName => $subValue) {
					if(is_array($subValue)){
						...
						$subItemTag = $itemTag->appendChild($doc->createElement($prefix . $subName, $doc->createCDATASection($valuePrefix . $subTagValue)));
				...
				$itemTag = $item->appendChild($doc->createElement($prefix . $name, $doc->createCDATASection($valuePrefix . $tagValue )));
